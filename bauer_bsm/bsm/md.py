...
def md_for_snapshot_data(snapshot, trace=None):
    ...
    update_md_from_point(md, snapshot.points['MA2'], trace=trace)
    ...
    update_md_from_point(md, snapshot.points['DIChgOS'], trace=trace)
    update_md_from_point(md, snapshot.points['DIChgEpoch'], trace=trace)
    update_md_from_point(md, snapshot.points['DIChgTZO'], trace=trace)
    update_md_from_point(md, snapshot.points['DOChgOS'], trace=trace)
    update_md_from_point(md, snapshot.points['DOChgEpoch'], trace=trace)
    update_md_from_point(md, snapshot.points['DOChgTZO'], trace=trace)
